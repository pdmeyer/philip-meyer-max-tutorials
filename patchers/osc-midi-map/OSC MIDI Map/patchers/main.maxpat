...
, 			{
				"box" : 				{
					...
					"text" : "FullPacket 112 5546426368"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-1",
					"items" : [ "IAC Driver StreamDeck2Daw", ",", "IAC Driver Daw2StreamDeck", ",", "Faderfox EC4", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"name" : "pdm.midi.map.maxpat",
				"bootpath" : "~/Documents/Max 9/Library_/philip-meyer-max-tutorials/patchers/osc-midi-map/OSC MIDI Map/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
